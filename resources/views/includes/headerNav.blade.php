            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  ...
                  <li><a href="{{route('carList')}}" class="nav-link {{ request()->routeIs('carList') ? 'active' : '' }}">Listing</a></li>
                  ...
                  <li><a href="{{route('contactUs')}}" class="nav-link {{ request()->routeIs('contactUs') ? 'active' : '' }}">Contact</a></li>
                </ul>
              </nav>
            </div>
