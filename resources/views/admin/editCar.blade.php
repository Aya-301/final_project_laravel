									...
									<form action="{{route('updateCar', $cars->id)}}" method="post" enctype="multipart/form-data">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												...
												<img src="{{ asset('assets/img/'.$cars->image) }}" alt="" style="width: 200px; lenth: 200px;">
											</div>
											@error('image')
											<div class="alert alert-danger">{{ $message }}</div>
											@enderror
											<input type="hidden" value="{{$cars->image}}" name="oldImage">
										</div>
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												<a href="{{route('cars')}}" class="btn btn-primary" type="button">Cancel</a>
