					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form action="{{route('updateTestimoninal', $testimonials->id)}}" method="post" enctype="multipart/form-data">
										@csrf
										@method('put')
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												...
												<img src="{{ asset('assets/img/'.$testimonials->image) }}" alt="" style="width:100px;">
											</div>
											@error('image')
											<div class="alert alert-danger">{{ $message }}</div>
											@enderror
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												<a href="{{route('admintestimonials')}}" class="btn btn-primary" type="button">Cancel</a>
